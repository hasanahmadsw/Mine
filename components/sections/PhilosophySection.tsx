    ...
    <section id="philosophy" className="py-20">
      <div className="container  px-4">
        <div className="mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl ">{t("philosophy.subtitle")}</p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <Card className=" shadow-md overflow-hidden h-full">
            <CardHeader className="border-b p-6">
              <h3 className="font-semibold text-xl">{t("philosophy.principles.innovation.title")}</h3>
            </CardHeader>
            <CardContent className="p-6">
              <p className="text-muted-foreground">{t("philosophy.principles.innovation.description")}</p>
            </CardContent>
          </Card>
          
          <Card className=" shadow-md overflow-hidden h-full">
            <CardHeader className="border-b p-6">
              <h3 className="font-semibold text-xl">{t("philosophy.principles.leadership.title")}</h3>
            </CardHeader>
            <CardContent className="p-6">
              <p className="text-muted-foreground">{t("philosophy.principles.leadership.description")}</p>
            </CardContent>
          </Card>
          
          <Card className="shadow-md overflow-hidden h-full">
            <CardHeader className="border-b p-6">
              <h3 className="font-semibold text-xl">{t("philosophy.principles.growth.title")}</h3>
            </CardHeader>
            <CardContent className="p-6">
              <p className="text-muted-foreground">{t("philosophy.principles.growth.description")}</p>
            </CardContent>
          </Card>
        </div>
